...
// This function always returns the remainder of the positive number
...
async function main() {
    ...
    for (let ii = 0; ii < numObjects; ++ii) {
        ...
        const object = {
            uniforms: {
                u_color_multiply: chroma.hsv(positiveModulo(baseHue + rand(120), 360), rand(0.5, 1), rand(0.5, 1)).gl(),
